...
export class MathemHarvester {
    ...
    static async getProducts(categoryURL) {
        let raw = await fetch(
            "https://api.mathem.io/product-https://api.mathem.io/product-search/noauth/categorylist/frukt-o-gront?storeId=16&productSizePerCategory=50&categorySize=20/noauth/categorylist/" + categoryURL + "&size=10000"
        );
        return await raw.json();
    }
